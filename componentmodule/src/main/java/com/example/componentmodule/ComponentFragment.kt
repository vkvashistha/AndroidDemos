 ...
 * [ComponentFragment.OnFragmentInteractionListener] interface
...
class ComponentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d("ComponentFragment", "Component Fragment...... onViewCreated()")
        tv_component.setOnClickListener {
            findNavController(this).navigate(R.id.action_componentFragment_to_componentChildFragment)
        }
    }
